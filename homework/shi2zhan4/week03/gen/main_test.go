...
import (
	annotation2 "demo-golang/homework/shi2zhan4/week03/gen/annotation"
	"demo-golang/homework/shi2zhan4/week03/gen/http"
	"errors"
	"fmt"
	...
	tests := []struct {
	...
	}{
		{
			...
			*/
			name: "no annotations",
			typ: annotation2.Type{
				Annotations: annotation2.Annotations[*ast.TypeSpec]{
					Node: &ast.TypeSpec{
						Name: ident("UserService"),
					},
				},
				Fields: []annotation2.Field{
					{
						Annotations: annotation2.Annotations[*ast.Field]{
							Node: &ast.Field{
								Names: idents("Get"),
								Type: &ast.FuncType{
			...
			*/
			...
			typ: annotation2.Type{
				Annotations: annotation2.Annotations[*ast.TypeSpec]{
					...
					Ans: []annotation2.Annotation{{"ServiceName", "MyUserService"}},
				},
				Fields: []annotation2.Field{
					{
						Annotations: annotation2.Annotations[*ast.Field]{
							...
							Ans: []annotation2.Annotation{{Key: "Path", Value: "/user"}},
						},
					},
				},
			},
