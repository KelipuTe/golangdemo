...
func (t *DialConn) makeHandshakeReq(req *http2.Request) {
...
func (t *DialConn) sendHandshakeReq(req *http2.Request) error {
...
func (t *DialConn) waitHandshakeResp(resp *http2.Response) {
...
func (t *DialConn) checkHandshakeResp(resp *http2.Response) error {
	//检查握手信息
