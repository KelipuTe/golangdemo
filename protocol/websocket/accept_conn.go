...
func (t *AcceptConn) parseReq(req *http2.Request) error {
	copyBuffer := t.readBuffer[0:t.readBufferLen]
...
func (t *AcceptConn) isHandshakeReq(req *http2.Request) bool {
...
func (t *AcceptConn) checkHandshakeReq(req *http2.Request, resp *http2.Response) error {
	//检查握手信息
	...
	resp.Status = http2.StatusSwitchingProtocols
...
func (t *AcceptConn) sendHttpResp(resp *http2.Response) error {
